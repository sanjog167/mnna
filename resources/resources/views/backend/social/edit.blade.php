...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('social.update.store', $social->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Social Initiative Main Image')}} <small></small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" value="{{$social->thumbnail_img}}" name="thumbnail_img" class="selected-files">
                                </div>
