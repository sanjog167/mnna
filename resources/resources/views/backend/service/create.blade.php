...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{ route('service.store') }}" method="POST">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('service Title')}}" onkeyup="makeSlug(this.value)" id="title" name="title" class="form-control" required>
                        </div>
                    </div>
                              <div class="form-group row">
