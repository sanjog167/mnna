...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/events/all', 'ProductController@all_products')->name('products.all');
    Route::get('/products/create', 'ProductController@create')->name('products.create');
    Route::get('/event/admin/{id}/edit', 'ProductController@admin_product_edit')->name('products.admin.edit');
    ...
    Route::get('/all_orders/{id}/show', 'OrderController@all_orders_show')->name('all_orders.show');
     ...
     Route::get('/all_forms', 'FormController@all_forms')->name('all_forms.index');
    Route::get('/all_forms/{id}/show', 'FormController@all_forms_show')->name('all_forms.show');
    
      Route::get('/forms/destroy/{id}', 'FormController@destroy')->name('forms.destroy');
    ...
    //Blog Section
    Route::resource('sponsor-category', 'BlogCategoryController');
    Route::get('/sponsor-category/destroy/{id}', 'BlogCategoryController@destroy')->name('blog-category.destroy');
    Route::resource('sponsor', 'BlogController');
    Route::get('/sponsor/destroy/{id}', 'BlogController@destroy')->name('sponsor.destroy');
    Route::post('/sponsor/change-status', 'BlogController@change_status')->name('blog.change-status');
    
    
    //MediaCoverage Section
    Route::resource('mediacoverage-category', 'MediacoverageCategoryController');
    Route::get('/mediacoverage-category/destroy/{id}', 'MediacoverageCategoryController@destroy')->name('mediacoverage-category.destroy');
    Route::resource('mediacoverage', 'MediacoverageController');
    Route::get('/mediacoverage/destroy/{id}', 'MediacoverageController@destroy')->name('mediacoverage.destroy');
    Route::post('/mediacoverage/change-status', 'MediacoverageController@change_status')->name('mediacoverage.change-status');
    ...
    Route::get('/event-delete/{id}', 'EventController@eventdelete')->name('event.destory');
    Route::post('/event-update-store/{id}', 'EventController@eventupdatestore')->name('event.update.store'); 
    Route::post('/event-upcoming', 'EventController@eventupcoming')->name('event.upcoming');

       //Services
    Route::resource('service', 'ServiceController');  
    Route::get('/service-edit/{id}', 'ServiceController@serviceedit')->name('service.edit'); 
    Route::get('/service-delete/{id}', 'ServiceController@servicedelete')->name('service.destory');
    Route::post('/service-update-store/{id}', 'ServiceController@serviceupdatestore')->name('service.update.store');

           //Collab
    Route::resource('collab', 'CollaborationController');  
    Route::get('/collab-edit/{id}', 'CollaborationController@collabedit')->name('collab.edit'); 
    Route::get('/collab-delete/{id}', 'CollaborationController@collabdelete')->name('collab.destory');
    Route::post('/collab-update-store/{id}', 'CollaborationController@collabupdatestore')->name('collab.update.store');

               //Join the team
    Route::resource('join', 'JoinController');  
    Route::get('/join-edit/{id}', 'JoinController@joinedit')->name('join.edit'); 
    Route::get('/join-delete/{id}', 'JoinController@joindelete')->name('join.destory');
    Route::post('/join-update-store/{id}', 'JoinController@joinupdatestore')->name('join.update.store');
    ...
    //homepage banner
     Route::get('/homepagebanner', 'HomeController@homepagebanner')->name('homepagebanner');

    //Projects Involved
    Route::get('/projectsinvolved', 'HomeController@projectsinvolved')->name('projectsinvolved'); 

    //What We Do
    Route::get('/whatwedo', 'HomeController@whatwedo')->name('whatwedo'); 

    //Collaboration
    Route::get('/collaboration', 'HomeController@collaboration')->name('collaboration');  
    ...
    Route::get('/banner-edit/{id}', 'HomebannerController@banneredit')->name('banner.edit'); 
    Route::get('/banner/destroy/{id}', 'HomebannerController@destroy')->name('banner.destroy');
    Route::post('/banner-update-store/{id}', 'HomebannerController@bannerupdatestore')->name('banner.update.store'); 
    ...
    Route::post('/team-update-store/{id}', 'TeamController@teamupdatestore')->name('team.update.store'); 
    
    Route::resource('advisor', 'AdvisorController');  
    Route::get('/advisor-edit/{id}', 'AdvisorController@advisoredit')->name('advisor.edit'); 
    Route::get('/advisor/destroy/{id}', 'AdvisorController@destroy')->name('advisor.destroy');
    Route::post('/advisor-update-store/{id}', 'AdvisorController@advisorupdatestore')->name('advisor.update.store');
    
    Route::resource('ambassador', 'AmbassadorController');  
    Route::get('/ambassador-edit/{id}', 'AmbassadorController@ambassadoredit')->name('ambassador.edit'); 
    Route::get('/ambassador/destroy/{id}', 'AmbassadorController@destroy')->name('ambassador.destroy');
    Route::post('/ambassador-update-store/{id}', 'AmbassadorController@ambassadorupdatestore')->name('ambassador.update.store');
    
    Route::resource('pastevent', 'PastEventController');  
    Route::get('/pastevent-edit/{id}', 'PastEventController@pasteventedit')->name('pevent.edit'); 
    Route::get('/pastevent/destroy/{id}', 'PastEventController@destroy')->name('pevent.destroy');
    Route::post('/pastevent-update-store/{id}', 'PastEventController@pasteventupdatestore')->name('pevent.update.store');
    
    
    

    Route::resource('winner', 'WinnerController');  
    Route::get('/winner-edit/{id}', 'WinnerController@winneredit')->name('winner.edit'); 
    Route::get('/winner/destroy/{id}', 'WinnerController@destroy')->name('winner.destroy');
    Route::post('/winner-update-store/{id}', 'WinnerController@winnerupdatestore')->name('winner.update.store');
    
    Route::resource('mentor', 'MentorController');  
    Route::get('/mentor-edit/{id}', 'MentorController@mentoredit')->name('mentor.edit'); 
    Route::get('/mentor/destroy/{id}', 'MentorController@destroy')->name('mentor.destroy');
    Route::post('/mentor-update-store/{id}', 'MentorController@mentorupdatestore')->name('mentor.update.store');
...
Route::resource('faq', 'FaqController');  
        ...
        Route::post('/faq-update-store/{id}', 'FaqController@faqupdatestore')->name('faq.update.store');
        
        Route::resource('socialinitiative', 'SocialinitiativeController');  
        Route::get('/socialinitiative-edit/{id}', 'SocialinitiativeController@socialinitiativeedit')->name('socialinitiative.edit'); 
        Route::get('/socialinitiative/destroy/{id}', 'SocialinitiativeController@destroy')->name('socialinitiative.destroy');
        Route::post('/socialinitiative-update-store/{id}', 'SocialinitiativeController@socialinitiativeupdatestore')->name('socialinitiative.update.store');
        ...
        Route::resource('mail', 'DynamicMailController');  
        Route::get('/mail-edit/{id}', 'DynamicMailController@mailedit')->name('mail.edit'); 
        Route::get('/mail/destroy/{id}', 'DynamicMailController@destroy')->name('mail.destroy');
        Route::post('/mail-update-store/{id}', 'DynamicMailController@mailupdatestore')->name('mail.update.store');
    
    Route::resource('media', 'MediaController');  
    Route::get('/media-edit/{id}', 'MediaController@mediaedit')->name('media.edit'); 
    Route::get('/media/destroy/{id}', 'MediaController@destroy')->name('media.destroy');
    Route::post('/media-update-store/{id}', 'MediaController@mediaupdatestore')->name('media.update.store');
    

          //Aboutindex

    Route::get('/aboutus','AppearanceController@index')->name('aboutus.index');

    Route::get('/create','AppearanceController@create')->name('aboutus.create');

    Route::post('/store','AppearanceController@store')->name('aboutus.store');

    Route::get('/aboutedit/{about}','AppearanceController@aboutedit')->name('aboutus.edit');

    Route::post('/aboutupdate/{about}','AppearanceController@aboutupdate')->name('aboutus.update');
