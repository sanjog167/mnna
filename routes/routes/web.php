...
Route::get('/team', 'HomeController@frontteam')->name('frontteam');  

Route::get('/sponsors', 'HomeController@sponsor')->name('sponsor');  


Route::get('/archives', 'HomeController@archive')->name('archive');  
Route::get('/contact-us', 'HomeController@contact')->name('contact');  


Route::get('/mnna-2018', 'HomeController@mnaneighteen')->name('mnaneighteen');
Route::get('/mnna-2019', 'HomeController@mnannineteen')->name('mnannineteen');
Route::get('/mnna-2021', 'HomeController@mnantwentyone')->name('mnantwentyone');
Route::get('/mnna-2022', 'HomeController@mnantwentytwo')->name('mnantwentytwo');
Route::get('/mnna-2023', 'HomeController@mnantwentythree')->name('mnantwentythree');


Route::get('/mediacoverage', 'HomeController@mediacoverage')->name('mediacoverage');  
...
Route::get('/confirmation', 'HomeController@confirmation')->name('confirmation');
    ...
    Route::get('/our-history', 'HomeController@ourhistory')->name('ourhistory');  
...
Route::get('get-products/{attribute_value}','HomeController@getProdcuts')->name('get.products');
Route::get('properties-by-location/{attribute_value}','HomeController@getProdcutsbylocation')->name('get.productsbylocation');
Route::get('get-productsrent/{attribute_value}','HomeController@getProdcutsrent')->name('get.productsrent');
...
Route::get('/search-rent', 'SearchController@indexrent')->name('searchrent');
...
Route::post('/ajax-searchrent', 'SearchController@ajax_searchrent')->name('search.ajaxrent');
...
Route::get('/properties/rent', 'HomeController@load_latest_section_detailrent')->name('home.section.latestdetailrent');
Route::get('/properties/sale', 'HomeController@load_latest_section_detailsale')->name('home.section.latestdetailsale');

Route::get('/all-event/{slug}', 'HomeController@product')->name('product');
...
//Paypal START
Route::get('paymentsuccess', 'PaypalController@success')->name('payment.done');
Route::get('error', 'PaypalController@getCancel')->name('payment.cancel');
Route::post('pay', 'PaypalController@pay')->name('payment.start');   

Route::post('pay', 'Paypalv2Controller@pay')->name('paymentv2.start');  
Route::get('paymentsuccess', 'Paypalv2Controller@paymentsuccess')->name('paymentv2.done');  
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/products/add-more-choice-option', 'ProductController@add_more_choice_option')->name('products.add-more-choice-option');
     ...
     Route::post('like-post/{id}', 'ProductController@likePost')->name('like.post');
     Route::post('unlike-post/{id}', 'ProductController@unlikePost')->name('unlike.post');
...
Route::resource('users', 'ShopController');
...
//Event Section
Route::get('/events', 'HomeController@all_events')->name('events'); 
Route::get('/event/{slug}', 'HomeController@eventdetail')->name('eventdetail');

Route::get('/apply', 'HomeController@usaform')->name('usaform'); 

//Collab Section
Route::get('/collaborations', 'HomeController@collaborations')->name('collaborations'); 
Route::get('/collaboration/{slug}', 'HomeController@collaborationdetail')->name('collaborationdetail');

Route::get('/our-products', 'HomeController@ourproducts')->name('ourproducts'); 

Route::get('/join-our-team', 'HomeController@jointeam')->name('jointeam'); 

Route::resource('contact', 'ContactController');  
Route::get('/contact-list', 'ContactController@contactlist')->name('contactlist'); 
