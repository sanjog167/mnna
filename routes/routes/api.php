...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language','cors']], function() {
    Route::post('login', 'Api\V2\AuthController@login');
    Route::post('signup', 'Api\V2\AuthController@signup');
    Route::post('uploads', 'Api\V2\AuthController@uploads');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    Route::prefix('delivery-boy')->group(function () {
        Route::get('dashboard-summary/{id}', 'Api\V2\DeliveryBoyController@dashboard_summary')->middleware('apiauth');
        Route::get('deliveries/completed/{id}', 'Api\V2\DeliveryBoyController@completed_delivery')->middleware('apiauth');
        Route::get('deliveries/cancelled/{id}', 'Api\V2\DeliveryBoyController@cancelled_delivery')->middleware('apiauth');
        Route::get('deliveries/on_the_way/{id}', 'Api\V2\DeliveryBoyController@on_the_way_delivery')->middleware('apiauth');
        Route::get('deliveries/picked_up/{id}', 'Api\V2\DeliveryBoyController@picked_up_delivery')->middleware('apiauth');
        Route::get('deliveries/assigned/{id}', 'Api\V2\DeliveryBoyController@assigned_delivery')->middleware('apiauth');
        Route::get('collection-summary/{id}', 'Api\V2\DeliveryBoyController@collection_summary')->middleware('apiauth');
        Route::get('earning-summary/{id}', 'Api\V2\DeliveryBoyController@earning_summary')->middleware('apiauth');
        Route::get('collection/{id}', 'Api\V2\DeliveryBoyController@collection')->middleware('apiauth');
        Route::get('earning/{id}', 'Api\V2\DeliveryBoyController@earning')->middleware('apiauth');
        Route::get('cancel-request/{id}', 'Api\V2\DeliveryBoyController@cancel_request')->middleware('apiauth');
        Route::post('change-delivery-status', 'Api\V2\DeliveryBoyController@change_delivery_status')->middleware('apiauth');
    });
    ...
    Route::get('chat/conversations/{id}', 'Api\V2\ChatController@conversations')->middleware('apiauth');
    Route::get('chat/messages/{id}', 'Api\V2\ChatController@messages')->middleware('apiauth');
    Route::post('chat/insert-message', 'Api\V2\ChatController@insert_message')->middleware('apiauth');
    Route::get('chat/get-new-messages/{conversation_id}/{last_message_id}', 'Api\V2\ChatController@get_new_messages')->middleware('apiauth');
    Route::post('chat/create-conversation', 'Api\V2\ChatController@create_conversation')->middleware('apiauth');
    ...
    //Route::get('purchase-history/{id}', 'Api\V2\PurchaseHistoryController@index')->middleware('apiauth');
    //Route::get('purchase-history-details/{id}', 'Api\V2\PurchaseHistoryDetailController@index')->name('purchaseHistory.details')->middleware('apiauth');
    ...
    Route::get('cart-summary/{user_id}', 'Api\V2\CartController@summary')->middleware('apiauth');
    Route::post('carts/process', 'Api\V2\CartController@process')->middleware('apiauth');
    Route::post('carts/add', 'Api\V2\CartController@add')->middleware('apiauth');
    Route::post('carts/change-quantity', 'Api\V2\CartController@changeQuantity')->middleware('apiauth');
    Route::apiResource('carts', 'Api\V2\CartController')->only('destroy')->middleware('apiauth');
    Route::post('carts/{user_id}', 'Api\V2\CartController@getList')->middleware('apiauth');


    Route::post('coupon-apply', 'Api\V2\CheckoutController@apply_coupon_code')->middleware('apiauth');
    Route::post('coupon-remove', 'Api\V2\CheckoutController@remove_coupon_code')->middleware('apiauth');

    Route::post('update-address-in-cart', 'Api\V2\AddressController@updateAddressInCart')->middleware('apiauth');
    ...
    Route::get('shop/user/{id}', 'Api\V2\ShopController@shopOfUser')->middleware('apiauth');
    ...
    Route::get('user/info/{id}', 'Api\V2\UserController@info')->middleware('apiauth');
    Route::post('user/info/update', 'Api\V2\UserController@updateName')->middleware('apiauth');
    Route::get('user/shipping/address/{id}', 'Api\V2\AddressController@addresses')->middleware('apiauth');
    Route::post('user/shipping/create', 'Api\V2\AddressController@createShippingAddress')->middleware('apiauth');
    Route::post('user/shipping/update', 'Api\V2\AddressController@updateShippingAddress')->middleware('apiauth');
    Route::post('user/shipping/update-location', 'Api\V2\AddressController@updateShippingAddressLocation')->middleware('apiauth');
    Route::post('user/shipping/make_default', 'Api\V2\AddressController@makeShippingAddressDefault')->middleware('apiauth');
    Route::get('user/shipping/delete/{id}', 'Api\V2\AddressController@deleteShippingAddress')->middleware('apiauth');

    Route::get('clubpoint/get-list/{id}', 'Api\V2\ClubpointController@get_list')->middleware('apiauth');
    Route::post('clubpoint/convert-into-wallet', 'Api\V2\ClubpointController@convert_into_wallet')->middleware('apiauth');

    Route::get('refund-request/get-list/{id}', 'Api\V2\RefundRequestController@get_list')->middleware('apiauth');
    Route::post('refund-request/send', 'Api\V2\RefundRequestController@send')->middleware('apiauth');
    ...
    Route::post('shipping_cost', 'Api\V2\ShippingController@shipping_cost')->middleware('apiauth');

    Route::post('coupon/apply', 'Api\V2\CouponController@apply')->middleware('apiauth');
    ...
    Route::get('bkash/begin', 'Api\V2\BkashController@begin')->middleware('apiauth');
    ...
    Route::get('nagad/begin', 'Api\V2\NagadController@begin')->middleware('apiauth');
    ...
    Route::post('payments/pay/wallet', 'Api\V2\WalletController@processPayment')->middleware('apiauth');
    Route::post('payments/pay/cod', 'Api\V2\PaymentController@cashOnDelivery')->middleware('apiauth');
    Route::post('payments/pay/manual', 'Api\V2\PaymentController@manualPayment')->middleware('apiauth');

    Route::post('offline/payment/submit', 'Api\V2\OfflinePaymentController@submit')->name('api.offline.payment.submit');

    Route::post('order/store', 'Api\V2\OrderController@store')->middleware('apiauth');
    Route::get('profile/counters/{user_id}', 'Api\V2\ProfileController@counters')->middleware('apiauth');
    Route::post('profile/update', 'Api\V2\ProfileController@update')->middleware('apiauth');
    Route::post('profile/update-device-token', 'Api\V2\ProfileController@update_device_token')->middleware('apiauth');
    Route::post('profile/update-image', 'Api\V2\ProfileController@updateImage')->middleware('apiauth');
    Route::post('profile/image-upload', 'Api\V2\ProfileController@imageUpload')->middleware('apiauth');
    Route::post('profile/check-phone-and-email', 'Api\V2\ProfileController@checkIfPhoneAndEmailAvailable')->middleware('apiauth');

    Route::post('file/image-upload', 'Api\V2\FileController@imageUpload')->middleware('apiauth');

    Route::get('wallet/balance/{id}', 'Api\V2\WalletController@balance')->middleware('apiauth');
    Route::get('wallet/history/{id}', 'Api\V2\WalletController@walletRechargeHistory')->middleware('apiauth');
