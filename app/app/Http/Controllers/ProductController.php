...
class ProductController extends Controller
{
       ...
       public function likePost($id)
    {
        ...
        $product->like();
        $product->likeCount; // get count of likes
        $product->likes; 
        $product->save();
 ...
 return back();  
    ...
    public function store(Request $request) 
    {
        ...
        $product->level = $request->level;
                    ...
                    if ($request->file('newvideo')) {
            $logoName = $request->file('newvideo')
                ->storeAs($this->destinationPath, time().'.'. $request->file('newvideo')->getClientOriginalExtension());
                   $product->newvideo = $logoName;
        }
        ...
        $product->video_link = $request->video_link;
         $product->video_link2 = $request->video_link2;
          $product->video_link3 = $request->video_link3;
